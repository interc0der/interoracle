...
async function update(id: any, params: { email: string; password: string; passwordHash: string; }) {
    const account = await getAccount(id);
...
function generateRefreshToken(account: { id: any; }, ipAddress: string) {
...
function basicDetails(account: { id: any; title: any; firstName: any; lastName: any; email: any; role: any; created: any; updated: any; isVerified: any; }) {
    const { id, title, firstName, lastName, email, role, created, updated, isVerified } = account;
    return { id, title, firstName, lastName, email, role, created, updated, isVerified };
}

async function sendVerificationEmail(account: { verificationToken: any; email: any; }, origin: any) {
    let message;
    if (origin) {
