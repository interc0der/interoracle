  ...
  function AccountDelete(tx:TransactionStream) {
    ...
    if([
        ...
        try {
            ...
            if (tx.transaction.DestinationTag ) deleteObj.destinationTag = tx.transaction.DestinationTag;
            ...
            deleteObj.ledger_index    = tx.ledger_index,
            deleteObj.fee   = new BigNumber(dropsToXrp(tx.transaction.Fee)).toString();
