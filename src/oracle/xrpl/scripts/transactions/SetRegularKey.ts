  ...
  function SetRegularKey(tx:TransactionStream) {
    ...
    if([
        ...
        try {
            ...
            keyObj.type = tx.transaction.RegularKey 
                            ? 'add' : 'remove'

            if (tx.transaction.SigningPubKey ) keyObj.master  = tx.transaction.SigningPubKey
            ...
            keyObj.master_disabled = (lsfDisableMaster & keyObj.tx_flag) === lsfDisableMaster ? true : false
